		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee List",
									"targetURL": "#joserojasemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"joserojasemployees-display": {
								"semanticObject": "joserojasemployees",
								"action": "display",
								"description": "Fiory employee List",
								"title": "Employee List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=joserojas.employees",
									"url": sap.ui.require.toUrl("joserojas/employees")
								}
							}
						}
					}
